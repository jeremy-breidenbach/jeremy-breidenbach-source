...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <a class="btn btn-primary" href="http://simpligroom.com" target="_blank">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <a class="btn btn-primary" href="http://nfo-maker.com" target="_blank">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <a class="btn btn-primary" href="http://petsitting4paws.com" target="_blank">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <a class="btn btn-primary" href="http://freight-damage-maps.heroku.com/" target="_blank">View Project <span class="glyphicon glyphicon-chevron-right"></span></a>
    </div>
</div>
